...
| `Current` | ✅ | <span style="color:#80EF80">+32.84%</span> | 670.1μs | 1.61% |
| `Current` | ❌ | <span style="color:#80EF80">+25.69%</span> | 16338.4μs | 2.02% |
...
| `Current` | ✅ | <span style="color:#FFEE8C">-4.72%</span> | 206.5μs | 2.85% |
...
| `Current` | ❌ | <span style="color:#FF746C">-53.86%</span> | 271.1μs | 3.68% |
...
| Construction (No Reordering) | 271.1μs| 597 | 3.68% | `Current` |
| Query (No Reordering) | 16338.4μs| 597 | 2.02% | `Current` |
| Construction (Reordering) | 206.5μs| 597 | 2.85% | `Current` |
| Query (Reordering) | 670.1μs| 597 | 1.61% | `Current` |
