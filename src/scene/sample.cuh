...
/// undesirable, so by specifying `blue_noise` an iterative relaxation procedure
...
/// more samples
/// @param relaxation_iters number of `sample_relaxation` iterations to conduct
/// in order to relax the uniform sampling into a more evenly spaced, blue noise
/// distribution
/// @return collection of coordinates of boundary samples
BoundarySamples sample_mesh(const Mesh mesh, const float h,
    const double oversampling_factor = 2.0, const int relaxation_iters = 10);
